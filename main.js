const chatInput = document.querySelector("#chat-input");//Soru İnputu
const sendButton = document.querySelector("#send-btn");//Mesaj Gönderme Butonu
const chatContainer = document.querySelector(".chat-container");//Sohbet Kapsayıcısı
const themeButton = document.querySelector("#theme-btn");//Gece Gündüz Butonu
const deleteButton = document.querySelector("#delete-btn");//Silme Butonu
const defaultText = document.querySelector(".default-text");//ChatGPT Clone Yazısı
